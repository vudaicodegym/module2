...
//Viết chương trình cho phép người dùng nhập vào một chuỗi bất kỳ
//và sau khi nhập xong chương trình sẽ hiển thị một chuỗi kí tự con được sắp xếp theo thứ tự từ bé đến lớn.
